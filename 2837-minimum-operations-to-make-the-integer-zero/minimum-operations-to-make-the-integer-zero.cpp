...
public:
    int makeTheIntegerZero(int num1, int num2) {
        ...
        for (ll k = 1; ; ++k) {
            ...
            //x can be represented as a sum of exactly k powers of 2 if and only if the number of powers of 2 needed (k) is at least the minimum required (__builtin_popcountll(x)) and at most the maximum possible (x).
